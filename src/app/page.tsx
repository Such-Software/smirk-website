      ...
      <div className="mb-12 flex flex-col items-center">
        ...
        {!user && (
          <div className="flex flex-col items-center mt-6">
            <p className="text-zinc-500 text-sm mb-3">Join us</p>
            <div className="flex gap-4">
              <a
                href="https://t.me/smirkwallet"
                target="_blank"
                rel="noopener noreferrer"
                className="text-zinc-500 hover:text-[#fbeb0a] transition-colors"
                title="Telegram"
              >
              ...
              <a
                href="https://discord.gg/7EnsaWTm6C"
                target="_blank"
                rel="noopener noreferrer"
                className="text-zinc-500 hover:text-[#fbeb0a] transition-colors"
                title="Discord"
              ...
              <a
                href="/feed"
                className="text-zinc-500 hover:text-[#fbeb0a] transition-colors"
                title="Nostr feed (self-sovereign)"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round">
                  <circle cx="12" cy="12" r="2" fill="currentColor" stroke="none" />
                  <path d="M7.5 16.5a6 6 0 0 1 0-9M4.7 19.3a10 10 0 0 1 0-14.6M16.5 7.5a6 6 0 0 1 0 9M19.3 4.7a10 10 0 0 1 0 14.6" />
                </svg>
              </a>
            </div>
          </div>
